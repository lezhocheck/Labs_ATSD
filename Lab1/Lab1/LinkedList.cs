...
namespace Lab1
{
    ...
    class LinkedList<T> where T : IComparable
    {
        ...
        public void AddItem(T item)
        {
            ...
            {
                while(temp.NextNode != null && temp.NextNode.Data.CompareTo(item) < 0)
                {
                    temp = temp.NextNode;
                }
        ...
        {
            Node<T> oldListTemp = Head;
            LinkedList<T> newList = new LinkedList<T>();
            while (oldListTemp != null)
            {
                Node<T> tempPointer = newList.Head;
                newList.Head = new Node<T>(oldListTemp.Data);
                newList.Head.NextNode = tempPointer;
                oldListTemp = oldListTemp.NextNode;
            }
            return newList;
        }
        public bool IsEmpty()
